...
(function () {
  ...
  var DICT = {
    ...
    uk: {
      ...
      "footer.tm": "3M, Avery Dennison, KPMF, Hexis та Oracal - торгові марки їхніх правовласників. Zap Wrap LLC незалежний установник: не авторизований дилер, не сертифікований установник і не афілійована особа жодного виробника плівки. Назви, моделі та зображення автомобілів наведені лише для ідентифікації.",
    ...
    he: {
      ...
      "footer.a11y": "נגישות",
      "footer.tm": "3M, Avery Dennison, KPMF, Hexis ו-Oracal הם סימנים מסחריים של בעליהם. Zap Wrap LLC היא מתקינה עצמאית: לא מפיצה מורשית, לא מתקינה מוסמכת ולא חברה קשורה של יצרן ויניל כלשהו. שמות, דגמים והדמיות של רכבים מוצגים לצורכי זיהוי בלבד.",
